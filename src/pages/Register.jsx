...
export default function Register() {
  ...
  return (
    <div>
      ...
      <Message info><Link to={"/registerEmployer"}><b>Şirkət hesabı açmaq üçün buraya daxil ol</b></Link></Message>
    </div>
  );
}
